...
SRC_URI="https://github.com/${PN}/${JDK_REPO}/archive/refs/tags/jdk-${MY_PV}.tar.gz -> ${P}.tar.gz"
...
IUSE="alsa cups debug doc examples headless-awt +jbootstrap selinux source +system-bootstrap systemtap"
