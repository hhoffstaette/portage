...
multilib_src_test() {
	...
	local libs_excluded=(
		...
		"qvm"
		#In file included from ../../../boost/regex/config.hpp:66,
		#				  from ../../../boost/cregex.hpp:23,
		#				  from ../../../boost/regex.h:22,
		#				  from c_compiler_checks/posix_api_check.c:23:
		#../../../boost/assert.hpp:32:1: error: unknown type name 'namespace'
		#   32 | namespace boost
		#      | ^~~~~~~~~
		#../../../boost/assert.hpp:33:1: error: expected '=', ',', ';', 'asm' or '__attribute__' before '{' token
		#   33 | {
		#      | ^
		"regex"
