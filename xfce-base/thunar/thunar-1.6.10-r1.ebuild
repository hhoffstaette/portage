...
src_prepare() {
	epatch "${FILESDIR}/${PV}-deactivate-SEND_MOVED-code-paths.patch"
	epatch "${FILESDIR}/${PV}-fix-crashes-when-reloading-target-file-after-move.patch"
	epatch "${FILESDIR}/${PV}-dont-call-g_object_ref-unref-on-objects-that-are-being-finalized.patch"
	epatch "${FILESDIR}/${PV}-inc-refcount-before-thunar_file_reload_deferred.patch"
}
