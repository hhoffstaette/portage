...
# For updates: https://pkgs.org/search/?q=skypeforlinux
SRC_URI="https://aur.andontie.net/x86_64/${PN}-bin-${PV}-1-x86_64.pkg.tar.zst"
S="${WORKDIR}"
...
src_install() {
	dodir /opt
	cp -a opt/skypeforlinux "${ED}"/opt || die
