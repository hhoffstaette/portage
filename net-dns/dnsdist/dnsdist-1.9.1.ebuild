...
PATCHES=(
	"${FILESDIR}/1.9.0-001-properly-handle-a-failure-of-the-first-lazy-health-check.patch"
	"${FILESDIR}/1.9.0-002-fix-exponential-backoff-computation-in-edge-cases.patch"
	"${FILESDIR}/1.9.0-003-properly-account-the-failure-to-forward-a-query-to-a-backend.patch"
	"${FILESDIR}/1.9.0-004-also-handle-EHOSTUNRERACH-as-a-case-for-reconnecting-the-socket.patch"
)
