...
REAL_V="1.42.4"
SRC_URI="http://ftp.gnome.org/pub/GNOME/sources/pango/$(ver_cut 1-2 ${REAL_V})/pango-${REAL_V}.tar.xz"
SRC_URI+=" https://dev.gentoo.org/~leio/distfiles/pango-${REAL_V}-patchset.tar.xz"
